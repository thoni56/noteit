...
import { createNote, getNote, deleteNote, updateNote, tagsForNote, addTagToNote, removeTagFromNote } from '../../api/notes.js';
...
export function removeTagFromCurrentNote(tagId) {
    removeTagFromNote(tagId, currentNoteId.get());
